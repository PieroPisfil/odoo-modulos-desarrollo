    ...
    const ReceiptScreenKaf = ReceiptScreen => 
        class extends ReceiptScreen  {
            ...
            async actualcurrentOrder() {
                ...
                const number_id = this.currentOrder.pos.validated_orders_name_server_id_map[this.currentOrder.name]
                await this._fetchSyncedOrders(number_id);
                this.render();
                //console.log(this._state.syncedOrders.cache[number_id])
                //return this.currentOrder
                return this._state.syncedOrders.cache[number_id];
            }
