...
class PosConfig(models.Model):
    ...
    invoice_journal_recibo_venta_id = fields.Many2one("account.journal", string="Diario de Recibos", domain=lambda self: "[('type', 'in', ['sale']), ('tipo_comprobante','=',%s), ('pe_invoice_code','=','')]" % self.env.ref('kaf-account-base.recibo_caja_1').id)
